    ...
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(
          widget.borderRadius == null ? Constants.radius : widget.borderRadius!,
        ),
        color: widget.color,
        boxShadow: [
          BoxShadow(
        ...
        border: Border.all(
          color:
              widget.borderColor == null ? widget.color! : widget.borderColor!,
        ),
      ),
      child: MaterialButton(
        ...
        child: Align(
          alignment:
              (widget.alignmentChild == null
                  ? Alignment.center
                  : widget.alignmentChild!),
          child: widget.child,
        ),
      ),
    );
