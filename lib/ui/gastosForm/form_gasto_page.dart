...
class FormGastosPage extends StatelessWidget {
  const FormGastosPage({super.key});

  void _initViewModel(BuildContext context) {
    final vm = Provider.of<FormGastoViewModel>(context, listen: false);
    final globalProvider = context.read<GlobalProvider>();
    if (globalProvider.mGasto.mIdx != null) {
      vm.initWithGlobalProvider(globalProvider);
    } else{
      vm.clear();
    }
  }
                        ...
                        CustomButton(
                          ...
                          callback: () async {
                            ...
                            if (result != null) {
                              ...
                              customShowToast(globalContext!, result);
                    ...
                    child: CustomButton(
                      ...
                      callback: () async {
                        ...
                        if (result != null) {
                          globalContext = context;
                          customShowToast(globalContext!, result);
                          globalContext!.read<HomeViewModel>().getGastos();
                          Navigator.pop(globalContext!);
                          Navigator.pop(globalContext!);
                        }
                      },
